...
export const ARC_CHAT_SUGGESTIONS: { label: string; prompt: string }[] = [
  ...
  { label: "What should I build?", prompt: "Suggest 5 concrete project ideas I could build on Arc Testnet right now, ranked by difficulty. For each: what it does, which Arc features it uses (USDC gas, CCTP, App Kit, FX, agents, privacy), and a rough tech stack." },
